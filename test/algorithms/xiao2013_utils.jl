...
using EliminateGraphs: find_children, unconfined_vertices, is_line_graph, first_twin, twin_filter!, short_funnel_filter!, desk_filter!, effective_vertex, all_three_funnel, all_four_funnel, rho, optimal_four_cycle, optimal_vertex, has_fine_structure, count_o_path
...
@testset "effective vertex" begin
    function is_effective_vertex(g::SimpleGraph, a::Int, S_a::Vector{Int})
        g_copy = copy(g)
        rem_vertices!(g_copy, EliminateGraphs.closed_neighbors(g, S_a))
...
@testset "funnel" begin
    function is_n_funnel(g::SimpleGraph, n::Int, a::Int, b::Int)
        degree(g,a) == n && EliminateGraphs.is_complete_graph(g, setdiff(neighbors(g,a), [b]))
    end
